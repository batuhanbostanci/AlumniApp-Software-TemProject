...
final erciyesEvent = Event(
    ...
    title:
        "BEŞİKTAŞ JK VE BESA GRUP YÖNETİM KURULU ÜYESİ MEZUNUMUZ EFE BEZCİ İLE CANLI YAYINDAYDIK !",
...
final halisahaEvent = Event(
    ...
    punchLine1: "Join us! ",
    punchLine2:
        "You think you have a talented squad? Let us see how competitive you are",
    categoryIds: [
      0,
      2
    ],
    galleryImages: [
      "assets/event_images/halısaha1.jpg",
      "assets/event_images/halısaha2.jpg",
      "assets/event_images/halısaha3.jpg"
    ]);
...
final musicConcert = Event(
    ...
    description:
        "Listen to last popular singles, tickets can be bought from avm.",
    location: "Almer Avm",
    duration: "5h",
    punchLine1: "Music Lovers!",
    punchLine2: "The latest starts are coming for you!",
    galleryImages: [
      "assets/event_images/singer1.jpg",
      "assets/event_images/singer2.jpg",
      "assets/event_images/singer3.jpg",
      "assets/event_images/singer4.jpg"
    ],
    categoryIds: [
      0,
      1
...
final golfCompetition = Event(
    ...
    galleryImages: [
      "assets/event_images/golf1.jpg",
      "assets/event_images/golf2.jpg",
      "assets/event_images/golf3.jpg"
    ],
    categoryIds: [
      0,
      2
...
final seminar = Event(
    ...
    description:
        "Jordan Bernt Peterson is a Canadian professor of psychology at the University of Toronto, a clinical psychologist, and YouTube personality. He began to receive widespread attention in the late 2010s for his views on cultural and political issues, often described as conservative",
